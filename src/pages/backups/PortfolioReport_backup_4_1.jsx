...
export default function PortfolioReport() {
  ...
  // Стоимость портфеля по средней цене покупки
  ...
  // Стоимость портфеля по актуальной цене (учитывает введённые пользователем цены)
  ...
  // Вычисляем прибыль/убыток по каждой проданной акции
  ...
  return (
    <Box sx={{ padding: 4, maxWidth: 900, margin: '0 auto' }}>
      ...
      <Box sx={{ mt: 4 }}>
        ...
        <Typography>
          <strong>Общая стоимость портфеля (по средней цене покупки):</strong> {portfolioValueByAvgPrice().toFixed(2)}
        </Typography>
        <Typography>
          <strong>Общая стоимость портфеля (по актуальной цене):</strong> {portfolioValueByActualPrice().toFixed(2)}
        </Typography>
        <Typography
          sx={{
            color: portfolioValueByActualPrice() - portfolioValueByAvgPrice() >= 0 ? 'green' : 'red',
            fontWeight: 'bold',
          }}
        >
          <strong>Прибыль/Убыток по портфелю:</strong>{' '}
          {(portfolioValueByActualPrice() - portfolioValueByAvgPrice()).toFixed(2)}
        </Typography>
